        ...
        reply_markup=InlineKeyboardMarkup(
            [
                ...
                [
                    ...
                    InlineKeyboardButton(
                        "❤️Asissten Bot", url=f"https://t.me/SujandraAsissten")
                ],[
                    InlineKeyboardButton(
                        "🤡 Owner Bot ", url=f"https://t.me/LordGanss10")
                ]
            ]
        ),
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '❤️ Asissten Bot', url=f"https://t.me/SujandraAsissten")],
    ...
    await message.reply_text(
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "📜 Cara Menggunakan BOT 📜", url="https://t.me/LordGanss10/32"
                    )
                ]
            ]
        ),
    ...
    await message.reply_text("""✅ Bot **berhasil dimulai ulang!**\n\n• **Daftar admin** telah **diperbarui**""",
      reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                        "Group Support", url=f"https://t.me/bacotsi"
                    ),
                    InlineKeyboardButton(
                        "🤡 Owner", url=f"https://t.me/LordGanss10"
                    )
                ]
            ]
        )
